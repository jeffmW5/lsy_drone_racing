...
class AttitudeRLExp013(Controller):
    ...
    def __init__(self, obs: dict[str, NDArray[np.floating]], info: dict, config: dict):
        ...
        # Set num of stacked obs (exp_013 trained with n_obs=2 — matching reference model)
        self.n_obs = 2
        ...
        # Load RL policy (obs_shape=73: basic_obs(13) + local_samples(30) + prev_obs(26) + last_action(4))
        self.agent = Agent((13 + 3 * self.n_samples + self.n_obs * 13 + 4,), (4,)).to("cpu")
        # = (73,) when n_obs=2
        model_path = Path("/media/drone-rl-lab/results/exp_013_racing_nobs_fix/model.ckpt")
