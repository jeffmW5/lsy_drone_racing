...
class AttitudeRLExp010(Controller):
    ...
    def __init__(self, obs: dict[str, NDArray[np.floating]], info: dict, config: dict):
        ...
        # Set num of stacked obs (our exp_010 was trained with n_obs=0 — no history stacking)
        self.n_obs = 0
        ...
        # Load RL policy (obs_shape=47: basic_obs(13) + local_samples(30) + last_action(4))
        self.agent = Agent((13 + 3 * self.n_samples + self.n_obs * 13 + 4,), (4,)).to("cpu")
        # = (47,) when n_obs=0
        model_path = Path("/media/drone-rl-lab/results/exp_010_racing_baseline/model.ckpt")
